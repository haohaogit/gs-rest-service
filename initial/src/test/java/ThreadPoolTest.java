...
import utils.DefaultThreadFactory;
...
public class ThreadPoolTest {
     ...
     *
     * @auther: dongQing
     * @date: 2018-12-23 19:45
     */
    class myRejectExecutionHandler implements RejectedExecutionHandler {

        @Override
        public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
            System.out.println(" my rejectHandler is do nothing!");
        }
    }

    /**
     *
     * 功能描述: test RejectExecutionHandler
     *
     * @auther: dongQing
     * @date: 2018-12-23 19:49
     */
    @Test
    public void rejectExecutionHandlerTest() {
        ThreadPoolExecutor executor = new ThreadPoolExecutor(3, 4, 5, TimeUnit.SECONDS,
                new LinkedBlockingDeque<Runnable>(1), new myRejectExecutionHandler());
        validateTemplate(executor);
    }
